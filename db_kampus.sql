...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Bulan Mei 2026 pada 07.42
...
CREATE TABLE `pendaftaran` (
  ...
  `status_berkas` enum('Pending','Lolos','Gagal') DEFAULT 'Pending',
  `nilai_ujian` int(11) DEFAULT NULL,
  `status_kelulusan` enum('Belum Diumumkan','Lulus','Tidak Lulus') DEFAULT 'Belum Diumumkan',
...
(1, 'admin', 'admin123', 'Administrator PMB');
